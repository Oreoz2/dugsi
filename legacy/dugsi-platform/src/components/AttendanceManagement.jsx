...
const classes = [
  { id: 1, name: 'Fasal 5', level: 'Beginner', students: 15, teacher: 'Ustadha Khadija', schedule: '09:00-10:30' },
  { id: 2, name: 'Fasal 6', level: 'Beginner', students: 18, teacher: 'Ustadh Muhammad', schedule: '10:45-12:15' },
  { id: 3, name: 'Fasal 7', level: 'Intermediate', students: 12, teacher: 'Ustadha Fatima', schedule: '09:00-10:30' },
  { id: 4, name: 'Fasal 8', level: 'Intermediate', students: 14, teacher: 'Ustadh Omar', schedule: '13:00-14:30' },
  { id: 5, name: 'Fasal 9', level: 'Advanced', students: 10, teacher: 'Ustadh Abdullah', schedule: '14:45-16:15' }
]
...
export function AttendanceManagement() {
  ...
  const [selectedClass, setSelectedClass] = useState('Fasal 7')
  ...
  const handleExportAttendance = () => {
    const csvData = attendanceRecords.map(record => ({
      ...
      'Attendance Rate': `${Math.round((record.present / record.totalStudents) * 100)}%`
    }))
  ...
  const handleViewReports = () => {
    alert('Redirecting to detailed attendance reports...')
  }
    ...
    <div className="p-6 space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          <Button variant="outline" onClick={handleExportAttendance} className="rounded-button">
            <Download className="w-4 h-4 mr-2" />
            Export
          </Button>
          <Button variant="outline" onClick={handleViewReports} className="rounded-button">
