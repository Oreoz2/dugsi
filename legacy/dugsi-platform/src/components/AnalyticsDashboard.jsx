...
const mockAnalyticsData = {
  ...
  classDistribution: [
    { name: 'Fasal 5', value: 22, color: '#8884d8' },
    { name: 'Fasal 6', value: 25, color: '#82ca9d' },
    { name: 'Fasal 7', value: 28, color: '#ffc658' },
    { name: 'Fasal 8', value: 24, color: '#ff7c7c' },
    { name: 'Fasal 9', value: 20, color: '#8dd1e1' },
    { name: 'Fasal 10', value: 18, color: '#d084d0' },
    { name: 'Fasal 11', value: 12, color: '#ffb347' },
    { name: 'Fasal 12', value: 7, color: '#87ceeb' }
  ],
  ...
  topPerformers: [
    { name: 'Fatima Al-Zahra', class: 'Fasal 7', score: 98, subject: 'Quran', avatar: 'FA' },
    { name: 'Omar Ibn Khattab', class: 'Fasal 9', score: 96, subject: 'Arabic', avatar: 'OIK' },
    { name: 'Aisha Siddique', class: 'Fasal 5', score: 95, subject: 'Aqeedah', avatar: 'AS' },
    { name: 'Ali Hassan', class: 'Fasal 8', score: 94, subject: 'Fiqh', avatar: 'AH' },
    { name: 'Maryam Ahmed', class: 'Fasal 6', score: 93, subject: 'Seerah', avatar: 'MA' }
  ],
  
  recentActivities: [
    { type: 'attendance', message: 'Fasal 7 achieved 98% attendance this week', time: '2 hours ago', icon: Users },
