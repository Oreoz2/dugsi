...
const mockAnnouncements = [
  ...
  {
    id: 2,
    title: 'Parent-Teacher Meeting - Fasal 7',
    content: 'We are pleased to invite all Fasal 7 parents for our monthly parent-teacher meeting. This is an excellent opportunity to discuss your child\'s progress and address any concerns.',
    author: 'Ustadha Fatima',
    timestamp: '2024-08-09T14:30:00Z',
    priority: 'medium',
    category: 'Meeting',
    recipients: 'Fasal 7 Parents',
    readCount: 18,
    totalRecipients: 24,
    status: 'published',
    attachments: [
    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="p-4 border-b border-border bg-background">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold">{conversation?.participant?.name || 'Unknown'}</h3>
              <p className="text-sm text-muted-foreground">
                {conversation?.participant?.status === 'online' ? 'Online' : 'Offline'} • {conversation?.participant?.role || 'User'}
              </p>
            </div>
          </div>
          
          <div className="flex gap-2">
            <Button variant="outline" size="sm" onClick={handlePhoneCall} className="rounded-button">
              <Phone className="w-4 h-4" />
            </Button>
            <Button variant="outline" size="sm" onClick={handleMoreOptions} className="rounded-button">
      ...
      <div className="p-4 border-t border-border bg-background">
        <div className="flex items-end gap-3">
          <div className="flex gap-2">
            <Button variant="outline" size="sm" onClick={handleAttachFile} className="rounded-button">
              <Paperclip className="w-4 h-4" />
            </Button>
            <Button variant="outline" size="sm" onClick={handleAttachImage} className="rounded-button">
