...
function Sidebar({ isOpen, onClose, user, onLogout }) {
  return (
    <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-sidebar border-r border-sidebar-border transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:static lg:inset-0`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="rounded-card shadow-card">
          ...
          <CardContent className="space-y-3">
            <Button className="w-full justify-start rounded-button hover-scale transition-modern">
              <UserCheck className="w-4 h-4 mr-2" />
              Mark Attendance
            </Button>
            <Button variant="outline" className="w-full justify-start rounded-button hover-scale transition-modern">
